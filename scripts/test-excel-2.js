...
console.log('🚀 Analizando segundo archivo de paciente...');

// Segundo archivo para comparar
const filePath = 'C:/Users/carlo/Downloads/DOCUMENTACION OFICIAL/DETALLES DE SERVICIO POR CLIENTE_/PCTE GABRIELA BORDA,(SAN BORJAS NORTE)/PCTE_ GABRIELA BORDA (SAN BORJAS).xlsx';
...
try {
  ...
  sheetNames.forEach((sheetName, index) => {
    ...
    // Mostrar primeras 10 filas para entender la estructura
