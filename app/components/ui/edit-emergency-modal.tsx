...
interface EditEmergencyModalProps {
  emergency: Emergency;
  onEmergencyUpdated: (emergency: Emergency) => void;
}
...
export function EditEmergencyModal({ emergency, onEmergencyUpdated }: EditEmergencyModalProps) {
  const [isOpen, setIsOpen] = useState(false);
  const [formData, setFormData] = useState<Emergency>(emergency);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onEmergencyUpdated(updatedEmergency);
    setIsOpen(false);
  };
      ...
      <DialogContent className="w-[95vw] max-w-[95vw] max-h-[90vh] overflow-y-auto sm:max-w-[95vw]">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-red-600">
            Editar Emergencia #{emergency.id}
          </DialogTitle>
          <DialogDescription>
            Modifique la información de la emergencia médica
          </DialogDescription>
        </DialogHeader>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{formData.patientAge} años</p>
                </div>
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge className={getTypeColor(formData.emergencyType)}>
                      {getTypeLabel(formData.emergencyType)}
                    </Badge>
                  </div>
                </div>
                <div>
